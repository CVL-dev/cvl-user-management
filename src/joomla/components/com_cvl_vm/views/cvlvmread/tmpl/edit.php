...
<div class="cvlvmread-edit front-end-edit">
    <h1>Edit <?php echo $this->item->id; ?></h1>

    <form id="form-cvlvmread" action="<?php echo JRoute::_('index.php?option=com_cvl_vm&task=cvlvmread.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
		...
		<div>
			...
			<?php echo JText::_('or'); ?>
			<a href="<?php echo JRoute::_('index.php?option=com_cvl_vm&task=cvlvmread.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

			<input type="hidden" name="option" value="com_cvl_vm" />
			<input type="hidden" name="task" value="cvlvmread.save" />
