...
class plgUserJoomla extends JPlugin
{
	...
	public function onUserAfterDelete($user, $succes, $msg)
	{
        ...
        exec("$mypath/CvlUserManagement.py --action 5 --username $myname --user_id $myid --path $mypath", $output, $returnCode);

        $mymessage = "Delete user name $myname, id $myid, return $returnCode";
        exec("echo $mymessage >> /tmp/cvldesktopinstaller_php.log");
...
//                {
//                    $uc_script = "~/bin/CvlUserAccount.sh";
//                    $uc_username = $user['username'];
//                    $uc_password = $user['password_clear'];
//                    exec("$uc_script '$uc_username' '$uc_password'");
//                }
